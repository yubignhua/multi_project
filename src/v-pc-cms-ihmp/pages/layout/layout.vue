  ...
  <div id="lay-out" class="lay-out">
    ...
    <el-container style="position:absolute;top:60px;width:100%;bottom: 0; border: 1px solid #eee">
      ...
      <el-aside width="230px" style="background-color:#ffffff">
        <div>
          <svg-icon width='40px' heigth="40px" color="rgb(94,186,157)" icon-class="email" />
          <svg-icon width='40px' heigth="40px" color="rgb(94,186,157)" icon-class="tree" />
        </div>
        <el-menu
          ...
          :router = "true">
          <el-submenu index="1">
            <template slot="title"><span style="color:#909399;"><svg-icon icon-class="app" /></span>用户基础信息管理</template>
            <el-menu-item-group>
